...
const ENABLE_PRODUCT_IMAGES = false;
...
/* =====================================================
   PRODUCT CARD (IMAGE HARD DISABLED)
===================================================== */
...
${
ENABLE_PRODUCT_IMAGES && item.image
? `
...
.register("/sw.js")
.then(()=>console.log("DigiRaja SW Registered"))
